      ...
      {items.map((item, idx) => {
        ...
        return (
          ...
          >
            ...
            <div className=" rounded-md w-full p-4 overflow-hidden bg-gray-900 group-hover:ring-2 ring-blue-500 relative z-20 transition-all duration-500 cursor-pointer">
