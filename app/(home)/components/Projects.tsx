    ...
    >
      <div>
        ...
        <div className="py-20 flex flex-col items-center justify-center">
          <div className="border-solid border-[1px] border-[#999] border-b-0 rounded-bl-[16px] rounded-br-[16px] rounded-tl-[16px] rounded-tr-[16px] flex flex-col cursor-auto text-left ">
            <div className="p-4">
            ...
            <div className=" border-t border-gray-300 text-left">
              <div className="p-4">
                <div>
                  <h2 className="text-lg font-bold ">PS Rental</h2>
                  <div className="prose prose-invert">
                    <p>
                      Rental Ps is a windows application used to record rental
                      business transactions using the c# programming language
                      and SQL database that implements the MVC system.
                    </p>
                    <p className="underline underline-offset-4 py-2 text-left">
                      Tech Stack:
                    </p>
              ...
              <div className="p-4">
                <div className="">
                  ...
                  <div className="prose prose-invert">
                    <p>
                      {
                        "This web was created using next js and tailwind with the aim of making my father's business web"
                      }
                    </p>
                    <p className="underline underline-offset-4 py-2 text-left">
                      Tech Stack:
                    ...
                    <div className="flex justify-between mt-2">
                      ...
                      <div className="flex gap-2">
                        <Link
                          ...
                          target="_blank"
                          className="hover:text-waikawa-gray-400 transition-colors"
                          href="https://github.com/Anezz12/mistar.v2"
                        >
                          <svg
                            stroke="currentColor"
                            fill="currentColor"
            ...
            <div className="border-t border-b  rounded-bl-[16px] rounded-br-[16px] border-gray-300">
              <div className="p-4">
                <div>
                  <h2 className="text-lg font-bold text-left">Coming Soon</h2>
                  <div className="prose prose-invert">
                    <p>Coming Soon</p>
                    <p className="underline underline-offset-4 py-2 text-left">
                      Tech Stack:
